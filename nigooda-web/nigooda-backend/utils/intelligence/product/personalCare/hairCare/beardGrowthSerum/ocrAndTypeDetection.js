      ...
      await openai.chat.completions.create({
        ...
        messages: [

          {
            ...
            content: `
You are a BeardGrowthSerum OCR engine.
...
`
    ...
    console.log(
      "BEARD GROWTH SERUM OCR STARTED",
      response.usage
    );
      ...
      await openai.chat.completions.create({
        ...
        messages: [

          {
            ...
            content: `
You are a BeardGrowthSerum ingredient cleaning engine.
...
`
    ...
    console.log(
      "BEARD GROWTH SERUM INGREDIENTS EXTRACTED:",
      response.usage
    );
