...
class OCRAndTypeDetection {
  ...
  async run({
    ...
    try {
      ...
      console.error(
        "DEODORANTANTIPERSPIRANT OCR ERROR:",
        error.message
      );
      ...
      await openai.chat.completions.create({
        ...
        messages: [

          {
            ...
            content: `
You are a DeodorantAntiperspirant OCR engine.
      ...
      await openai.chat.completions.create({
        ...
        messages: [

          {
            ...
            content: `
You are a DeodorantAntiperspirant ingredient cleaning engine.
...
`
    ...
    console.log(
      "DEODORANTANTIPERSPIRANT OCR TOKEN USAGE:",
      response.usage
    );
