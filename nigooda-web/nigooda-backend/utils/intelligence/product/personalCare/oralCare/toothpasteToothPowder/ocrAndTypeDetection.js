...
class OCRAndTypeDetection {
  ...
  async run({
    ...
    try {
      ...
      console.error(
        "TOOTHPASTETOOTHPOWDER OCR ERROR:",
        error.message
      );
      ...
      await openai.chat.completions.create({
        ...
        messages: [

          {
            ...
            content: `
You are a ToothpasteToothPowder OCR engine.
      ...
      await openai.chat.completions.create({
        ...
        messages: [

          {
            ...
            content: `
You are a ToothpasteToothPowder ingredient cleaning engine.
...
`
    ...
    console.log(
      "TOOTHPASTETOOTHPOWDER OCR TOKEN USAGE:",
      response.usage
    );
