...
class OCRAndTypeDetection {
  ...
  async run({
    ...
    try {
      ...
      console.error(
        "TEETHWHITENINGPRODUCT OCR ERROR:",
        error.message
      );
      ...
      await openai.chat.completions.create({
        ...
        messages: [

          {
            ...
            content: `
You are a TeethWhiteningProduct OCR engine.
      ...
      await openai.chat.completions.create({
        ...
        messages: [

          {
            ...
            content: `
You are a TeethWhiteningProduct ingredient cleaning engine.
...
`
    ...
    console.log(
      "TEETHWHITENINGPRODUCT OCR TOKEN USAGE:",
      response.usage
    );
