      ...
      await openai.chat.completions.create({
        ...
        messages: [

          {
            ...
            content: `
You are a TickFleaTreatment OCR engine.
      ...
      await openai.chat.completions.create({
        ...
        messages: [

          {
            ...
            content: `
You are a TickFleaTreatment ingredient cleaning engine.
...
`
    ...
    console.log(
      "TICKFLEATREATMENT OCR TOKEN USAGE:",
      response.usage
    );
