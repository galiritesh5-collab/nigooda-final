...
return await ClinicalEngine.run(
  extractedData
      ...
      console.error(
        "BATHROOMTOILETCLEANER OCR ERROR:",
        error.message
      );
      ...
      await openai.chat.completions.create({
        ...
        messages: [

          {
            ...
            content: `
You are a BathroomToiletCleaner OCR engine.
      ...
      await openai.chat.completions.create({
        ...
        messages: [

          {
            ...
            content: `
You are a BathroomToiletCleaner ingredient cleaning engine.
...
`
    ...
    console.log(
      "BATHROOMTOILETCLEANER OCR TOKEN USAGE:",
      response.usage
    );
