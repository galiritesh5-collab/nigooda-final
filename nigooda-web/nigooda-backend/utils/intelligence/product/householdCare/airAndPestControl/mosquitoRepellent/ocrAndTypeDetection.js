      ...
      await openai.chat.completions.create({
        ...
        messages: [

          {
            ...
            content: `
You are a MosquitoRepellent OCR engine.
      ...
      await openai.chat.completions.create({
        ...
        messages: [

          {
            ...
            content: `
You are a MosquitoRepellent ingredient cleaning engine.
...
`
    ...
    console.log(
      "MOSQUITOREPELLENT OCR TOKEN USAGE:",
      response.usage
    );
