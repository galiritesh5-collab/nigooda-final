      ...
      await openai.chat.completions.create({
        ...
        messages: [

          {
            ...
            content: `
You are a LaundryLiquidPowder OCR engine.
      ...
      await openai.chat.completions.create({
        ...
        messages: [

          {
            ...
            content: `
You are a LaundryLiquidPowder ingredient cleaning engine.
...
`
    ...
    console.log(
      "LAUNDRYLIQUIDPOWDER OCR TOKEN USAGE:",
      response.usage
    );
