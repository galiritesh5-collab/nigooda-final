...
const ProductAnalysisResultPage = () => {
  ...
  > = {
    oralcare: (
      <OralCare markdown={markdown} />
    ),
    haircare: (
      <HairCare markdown={markdown} />
    ),
    babycare: (
      <BabyCare markdown={markdown} />
    ),
    hygienecare: (
      <HygieneCare markdown={markdown} />
    ),
    householdcare: (
      <HouseholdCare markdown={markdown} />
    ),
    petcare: (
      <PetCare markdown={markdown} />
    ),
    bodycare: (
      <BodyCare markdown={markdown} />
    ),
    skincare: (
      <SkinCare markdown={markdown} />
    ),
  };
