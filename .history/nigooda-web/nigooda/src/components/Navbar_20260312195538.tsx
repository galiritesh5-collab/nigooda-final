    ...
    <nav className="fixed top-0 left-0 w-full z-[100] bg-white/90 backdrop-blur border-b shadow-sm">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          <div className="hidden md:block w-[420px] mx-4">
              ...
              return (
                <div key={cat.id} className="relative py-2 group">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 rounded-full text-sm font-semibold border bg-white hover:border-indigo-500 whitespace-nowrap flex-shrink-0"
                    >
                      {cat.label}
                    </button>
